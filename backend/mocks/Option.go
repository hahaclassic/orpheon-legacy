...
func (_m *Option) Execute(_a0 *tableoutput.TablePrinter) {
	_m.Called(_a0)
}
...
//   - _a0 *tableoutput.TablePrinter
func (_e *Option_Expecter) Execute(_a0 interface{}) *Option_Execute_Call {
	return &Option_Execute_Call{Call: _e.mock.On("Execute", _a0)}
}

func (_c *Option_Execute_Call) Run(run func(_a0 *tableoutput.TablePrinter)) *Option_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*tableoutput.TablePrinter))
	})
	return _c
}
...
func (_c *Option_Execute_Call) RunAndReturn(run func(*tableoutput.TablePrinter)) *Option_Execute_Call {
	_c.Run(run)
	return _c
}
